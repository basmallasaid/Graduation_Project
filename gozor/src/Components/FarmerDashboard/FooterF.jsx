...
export default function FooterF() {
  return (
    <>
     <footer className={` text-white ${styles.footerF}`}>
      ...
      <div className={styles.footer_bottom} style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center',backgroundColor:'#1f4e3dc5' }}>
