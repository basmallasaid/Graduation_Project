  ...
  return (
    <>
     <footer className={` text-white ${styles.footer}`}>
        <div className={`container ${styles.footer_container}`}>
          <div className="row">
            ...
            <h3>تواصل معنا</h3>
              ...
              <li className="me-5"><a href="" target="_blank" className="text-decoration-none">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="16" height="16"  fill="currentColor">
               <path fill="#ffffff" d="M279.1 288l14.2-92.7h-88.9v-60.1c0-25.4 12.4-50.1 52.2-50.1h40.4V6.3S260.4 0 225.4 0c-73.2 0-121.1 44.4-121.1 124.7v70.6H22.9V288h81.4v224h100.2V288z"/></svg></a></li>
                <li className="me-5"><a href="" target="_blank" className="text-decoration-none">
      ...
      <div className={styles.footer_bottom} style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
      <div style={{ textAlign: 'right' }} >
    <a className="text-decoration-none" href="#" style={{ color: "white" }}>Terms of Use |</a>  
    <a href="#" className="text-decoration-none" style={{ color: "white" }}>Privacy Policy</a>
  </div>
