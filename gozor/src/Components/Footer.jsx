...
export default function Footer() {
  return (
        ...
        <div className={`container ${styles.footer_container}`}>
          <div className="row">
            ...
            <h3>تواصل معنا</h3>
              ...
              <li className="me-5"><Link href="/" target="_blank" className="text-decoration-none">
    ...
    <Link className="text-decoration-none" href="#" style={{ color: "white" }}>Terms of Use |</Link>  
    <Link href="#" className="text-decoration-none" style={{ color: "white" }}>Privacy Policy</Link>
  </div>
